        ...
        if pos[0] < XMAPAMAX * scale + shift_x:
            try:
                colorAca = self.mapa.get_at((int(pos[0] - shift_x),
                                             int(pos[1] - shift_y)))
            except BaseException:  # probablemente click fuera de la imagen
                return False
...
class Conozco():
    ...
    def pantallaInicial(self):
        ...
        for n in self.listaNiveles:
            ...
            self.mostrarTexto(n.nombre,
                              ...
                              COLOR_OPTION_T)
            yLista += int(50 * scale)
        self.mostrarTexto(_("Explore"), self.fuente60, (int(
    ...
    def jugarNivel(self):
        ...
        for i in range(TOTALAVANCE - 1):
            ...
            l = pygame.draw.line(self.pantalla,
                                 COLORBARRA_C,
                                 (int(posx),
                                  int(YBARRA_A * scale + shift_y)),
                                 (int(posx),
                    ...
                    if not(self.esCorrecto):
                        if self.nRespuestasMal == 1:  # ayuda
                            ...
                            for i in range(TOTALAVANCE - 1):
                                ...
                                l = pygame.draw.line(
                                    self.pantalla, COLORBARRA_C, (int(posx), int(
